...
public class StringGame {
	public static void main(String[] args) {
		...
		String[] testStrings =
		{"inventor", "indistinguishable", "semblance", "registered", "ambidextrous", "advocate", "fantastic", "frontispiece", "intermittent"};
		String answer = "y";
		Scanner sc = new Scanner(System.in);
		while(answer.equals("y") || answer.equals("Y")){
			int randIndex = getRandomInt(0,testStrings.length-1);
