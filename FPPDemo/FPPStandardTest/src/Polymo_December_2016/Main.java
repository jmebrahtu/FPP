...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("The total combined Salary:" + salarySum);
	...
	public static List<EmployeeData> combine(List<Staff> staff, List<Teacher> teachers) {
		...
		ArrayList<EmployeeData> finalList = new ArrayList<EmployeeData>();

		finalList.addAll(staff);
		finalList.addAll(teachers);
